...
<div
	...
	class="max-w-screen absolute z-40 mx-[999rem] flex max-h-dvh flex-col rounded-lg border border-stone-400 bg-white focus-within:mx-0 peer-has-[:focus-within]/common_dropdown_open:mx-0 {dropdownClass}"
>
