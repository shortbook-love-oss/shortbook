...
<label class="block {className}">
	...
	<input
		...
		{required}
		bind:value
		class="block w-full rounded-md border border-stone-700 px-4 py-2 placeholder:text-stone-400 disabled:bg-stone-100 disabled:text-stone-500 [&:user-invalid]:border-2 [&:user-invalid]:border-red-700 {errorMessages?.length
