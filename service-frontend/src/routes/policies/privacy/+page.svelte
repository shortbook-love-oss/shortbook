<svelte:head>
	<title>Privacy policy | ShortBook</title>
</svelte:head>

<section class="mx-auto flex max-w-2xl flex-col gap-4">
	<h1 class="text-4xl font-semibold">プライバシーポリシー</h1>
  <p>合同会社ShortBook（以下，「当社」といいます。）は，有料記事投稿サービスのShortBook（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>

	<h2 class="mt-16 font-semibold text-xl">第1条（個人情報）</h2>
  <p>「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>

	<h2 class="mt-16 font-semibold text-xl">第2条（個人情報の収集方法）</h2>
  <p>本サービスは、外部サービスのアカウントを利用して登録します。</p>
  <p>当社は、ユーザーが利用登録をする際に、OAuthまたはOpen ID Connectの仕様に基づき、外部サービスに登録された情報のうち以下を収集します。</p>
  <ul class="list-disc ps-4">
    <li>ユーザーのハンドルネーム（本名は収集しません）</li>
    <li>プロフィールアイコンを参照するURL</li>
    <li>外部サービスにおいてログインのために使っているメールアドレス</li>
  </ul>

	<h2 class="mt-16 font-semibold text-xl">第3条（個人情報を収集・利用する目的）</h2>
  ...
  <ul class="list-disc ps-4">
	...
	<h2 class="mt-16 font-semibold text-xl">第4条（利用目的の変更）</h2>
  ...
  <p>利用目的の変更を行った場合には，変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。</p>
	...
	<h2 class="mt-16 font-semibold text-xl">第5条（個人情報の第三者提供）</h2>
  ...
  <ul class="list-disc ps-4">
	...
	<h2 class="mt-16 font-semibold text-xl">第6条（個人情報の開示）</h2>
  ...
  <p>前項の定めにかかわらず，履歴情報および特性情報などの個人情報以外の情報については，原則として開示いたしません。</p>
	...
	<h2 class="mt-16 font-semibold text-xl">第7条（個人情報の訂正および削除）</h2>
  ...
  <p>当社は，前項の規定に基づき訂正等を行った場合，または訂正等を行わない旨の決定をしたときは遅滞なく，これをユーザーに通知します。</p>
	...
	<h2 class="mt-16 font-semibold text-xl">第8条（個人情報の利用停止等）</h2>
  ...
  <h2 class="mt-16 font-semibold text-xl">第9条（プライバシーポリシーの変更）</h2>
  ...
  <h2 class="mt-16 font-semibold text-xl">第10条（お問い合わせ窓口）</h2>
  <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
  <ul>
    <li>社名：合同会社ShortBook</li>
    <li>住所：日本 愛知県西尾市富山町於三28番地15</li>
    <li>代表社員：倉地俊輔</li>
    <li>Eメールアドレス：contact-desk@shortbook.life</li>
  </ul>
</section>
