...
<section class="mx-auto flex max-w-2xl flex-col gap-4">
	...
	<h2 class="mt-16 text-xl font-semibold">第1条（適用）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第2条（利用登録）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第3条（ユーザーIDの管理）</h2>
	<p>
		ユーザーは自己の責任において、本サービスのユーザーID、及び紐づく外部サービスアカウントを適切に管理するものとします。
	</p>
	<p>
		ユーザーはいかなる場合にも、ユーザーID及び外部サービスアカウントを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。
	</p>
	<p>
		ユーザーID及び外部サービスアカウントが第三者によって使用されたことによって生じた損害は、当社に故意又は重大な過失がある場合を除き、当社は一切の責任を負わないものとします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第4条（利用料金および支払方法）</h2>
	<p>
		ユーザーは、本サービスの有料部分の対価として、当社が別途定め、本ウェブサイトに表示する利用料金を、当社が指定する方法により支払うものとします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第5条（禁止事項）</h2>
	...
	<h2 class="mt-16 text-xl font-semibold">第6条（本サービスの提供の停止等）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第7条（著作権）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第8条（利用制限および登録抹消）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第9条（退会）</h2>
	<p>ユーザーは、当社の定める退会手続により、本サービスから退会できるものとします。</p>

	<h2 class="mt-16 text-xl font-semibold">第10条（保証の否認および免責事項）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第11条（サービス内容の変更等）</h2>
	<p>
		当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第12条（利用規約の変更）</h2>
	<p>
	...
	<h2 class="mt-16 text-xl font-semibold">第13条（個人情報の取扱い）</h2>
	<p>
		当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第14条（通知または連絡）</h2>
	<p>
		ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第15条（権利義務の譲渡の禁止）</h2>
	<p>
		ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第16条（準拠法・裁判管轄）</h2>
	<p>本規約の解釈にあたっては、日本法を準拠法とします。</p>
	<p>
		本サービスに関して紛争が生じた場合には、当社の本店所在地を管轄する裁判所を専属的合意管轄とします。
	</p>

	<h2 class="mt-16 text-xl font-semibold">第17条（利用規約に関するお問い合わせ）</h2>
	<p>
		本ポリシーに関して疑問点がある場合、<a
	...
	<p>
		メールでのお問い合わせを希望する場合は、{envPublic.PUBLIC_EMAIL_INQUIRY_TO}に送信していただき、18時間以内に返信いたします。
	</p>
</section>
