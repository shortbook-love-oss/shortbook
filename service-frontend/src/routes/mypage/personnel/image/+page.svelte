...
<div class="mb-8 flex flex-wrap items-start gap-4">
	<picture>
		<source srcset="{user?.image}?ext=avif&w=128&h=128&q=80" type="image/avif" />
		<img
			src="{user?.image}?ext=png&w=128&h=128&q=80"
			class="h-32 w-32 rounded-md bg-white"
			alt="Profile icon"
		/>
	</picture>
	<picture>
		<source srcset="{user?.image}?ext=avif&w=64&h=64&q=80" type="image/avif" />
		<img
			src="{user?.image}?ext=png&w=64&h=64&q=80"
			class="h-16 w-16 rounded-md bg-white"
			alt="Profile icon"
		/>
	</picture>
	<picture>
		<source srcset="{user?.image}?ext=avif&w=32&h=32&q=80" type="image/avif" />
		<img
			src="{user?.image}?ext=png&w=32&h=32&q=80"
